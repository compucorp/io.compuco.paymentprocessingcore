<!-- CLAUDE.md v1.5 | Last updated: 2026-02-02 -->
...
- When proposing commits, use the `CIVIMM-###:` format from the shared guide
...
| Task | Prompt |
|------|--------|
| Generate tests | "Create PHPUnit tests for `ContributionCompletionService::complete()` covering success and error cases." |
